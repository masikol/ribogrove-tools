...
<li><a href="#top-density-highest">Топ-10 геномаў з найбольшай шчыльнасцю генаў 16S рРНК</a></li>
<li><a href="#top-density-lowest">Топ-10 геномаў з найменшай шчыльнасцю генаў 16S рРНК</a></li>
...
<ol style="list-style:none;">
  <li><strong>Катэгорыя 1</strong> (найбольшая надзейнасць). Геномы, якія не дэманструюць прыкмет нізкаякаснай зборкі і якія былі секвенаваныя з дапамогай тэхналогіі PacBio альбо камбінацыі (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina) або (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina).</li>
...
<details>
  ...
  <small>
    ...
    <li>
      ...
      Гэта TSV-файлы, якія змяшчаюць інфармацыю пра нуклеатыдны склад і памер паслядоўнасцей генаў. Першы файл з гэтых двух апісвае фінальныя паслядоўнасці, уключаныя ў RiboGrove, а другі — „забракаваныя“ паслядоўнасці.
    </li>
    <li>
    ...
    <li>
      ...
      Гэта TSV-файл, які змяшчае інфармацыю пра унутрыгеномную зменлівасць генаў 16S рРНК. Унутрыгеномную зменлівасць вылічалі толькі для геномаў катэгорыі&nbsp;1, у якіх ёсць хаця б два гены 16S рРНК. Для ацэнкі зменлівасці выкарыстоўвалі энтрапію Шэнана: выраўноўвалі паслядоўнасці генаў кожнага геному з дапамогай праграмы <a href="https://mafft.cbrc.jp/alignment/software/">MAFFT</a>, і пасля вылічалі энтрапію для кожнай калонкі множнага выраўноўвання.
    </li>
    <li>
      <span class="samp-highl">primer_pair_genomic_coverage.tsv</span><br>
      Гэта TSV-файл, які змяшчае геномнае пакрыццё пар <span title="Палімэразная ланцуговая рэакцыя" style="cursor:help">ПЛР</span>-праймераў да розных V-участкаў генаў 16S рРНК. Напрыклад, для сямейства <i>Enterobacteriaceae</i> геномнае пакрыццё пары праймераў — гэта адсотак геномаў <i>Enterobacteriaceae</i>, якія змяшчаюць прынамсі адзін ген 16S рРНК, на матрыцы якога (тэарытычна) можа сфармавацца ПЛР-прадукт з дапамогай гэтай пары праймераў.
    </li>
    <li>
      <span class="samp-highl">primer_pair_genomic_coverage.tsv</span><br>
      Гэта TSV-файл, які змяшчае значэнні шчыльнасці генаў 16S рРНК для кожнага генома. Шчыльнасць вызначаецца як колькасць копій гена 16S рРНК, падзеленая на памер геному і памножаная на 1 мільён пар асноў; такім чынам, гэта колькасць генаў 16S рРНК на 1 млн. п.а.
    </li>
  </ol></small>
</details>
</li>
...
<table class="sum-table"><caption>Топ-10 найдаўжэйшых генаў 16S рРНК</caption>
<tbody>
...
{% if rest_top_longest_df.query('Domain == "Bacteria"').shape[0] > 0 %}
  <details>
  <summary><i>Астатнія гены такой жа даўжыні (у дзясятку не ўвайшлі выпадкова)</i></summary>
...
<table class="sum-table"><caption>Топ-10 найкарацейшых генаў 16S рРНК</caption>
<tbody>
<tr><th class="alnleft">Арганізм</th><th class="numcol">Даўжыня, п.а.</th><th class="alnleft">SeqID <sup>*</sup></th><th class="alnleft">Код доступу<br>геномнай зборкі</th></tr>
<tr>
<td colspan="4" class="subhead">Бактэрыі</td>
...
<table class="sum-table"><caption>Топ-10 геномаў з найбольшай колькасцю копій генаў 16S рРНК</caption>
<tbody>
...
{% if rest_top_gcn_df.query('Domain == "Bacteria"').shape[0] > 0 %}
  <details>
    <summary><i>Астатнія геномы з такою ж колькасць копій (у дзясятку не ўвайшлі выпадкова)</i></summary>
  <table class="sum-table"><tbody>
  <tr><th class="alnleft">Арганізм</th><th class="numcol">Колькасць копій</th><th class="alnleft">Код доступу<br>геномнай зборкі</th></tr>
...
<table class="sum-table"><caption>Топ-10 геномаў з найбольшай шчыльнасцю генаў 16S рРНК
</caption>
<tbody>
<tr><th class="alnleft">Арганізм</th><th class="numcol">Шчыльнасць генаў<br />16S рРНК<sup> *</sup></th><th class="numcol">Колькасць копій<br />генаў 16S рРНК</th><th class="numcol">Памер геному<sup> **</sup></th><th class="alnleft">Код доступу<br>геномнай зборкі</th></tr>
<tr>
...
<p><sup>*</sup> Шчыльнасць гена 16S рРНК — гэта колькасць копій гена 16S рРНК, падзеленая на памер геному і памножаная на 1 мільён пар асноў, такім чынам, гэта колькасць генаў 16S рРНК на 1 млн. п.а..</p>
<p><sup>**</sup> Памер генома — гэта сума даўжынь усіх паслядоўнасцей зборкі.</p>

<div id="top-density-lowest" class="pad-anchor"></div>
<table class="sum-table"><caption>Топ-10 геномаў з найменшай шчыльнасцю генаў 16S рРНК
</caption>
<tbody>
<tr><th class="alnleft">Арганізм</th><th class="numcol">Шчыльнасць генаў<br />16S рРНК<sup> *</sup></th><th class="numcol">Колькасць копій<br />генаў 16S рРНК</th><th class="numcol">Памер геному<sup> **</sup></th><th class="alnleft">Код доступу<br>геномнай зборкі</th></tr>
<tr>
...
<h3>Спектр дзеяння<sup>*</sup> пар праймераў да розных V-регіёнаў бактэрыяльных генаў 16S рРНК</h3>

<p><sup>*</sup> Спектр дзеяння пары праймераў — гэта адсотак геномаў, якія маюць прынамсі адзін ген 16S рРНК, які магчыма ампліфікаваць з дапамогай ПЛР і з выкарыстаннем гэтай пары праймераў. Падрабязнасці апісаныя ў нашым <a href="https://doi.org/10.1016/j.resmic.2022.103936">артыкуле пра RiboGrove</a>.</p>
...
<tr>
  <th class="alnleft" rowspan="2">Тып</th>
...
<table class="sum-table"><caption>Архейныя гены, „архейныя“ праймеры</caption>
<tbody class="primer-cov-tbody">
<tr>
  <th class="alnleft" rowspan="2">Тып</th>
  <th class="numcol" rowspan="2">Колькасць<br />геномаў</th>
...
<details>
<summary><b>Бактэрыяльныя гены, „архейныя“ праймеры</b></summary>
<div id="primers-coverages" class="pad-anchor"></div>
<table class="sum-table"><caption>Бактэрыяльныя гены, „архейныя“ праймеры</caption>
<tbody class="primer-cov-tbody">
<tr>
  <th class="alnleft" rowspan="2">Тып</th>
  <th class="numcol" rowspan="2">Колькасць<br />геномаў</th>
...
<details>
<summary><b>Архейныя гены, „бактэрыяльныя“ праймеры</b></summary>
<table class="sum-table"><caption>Архейныя гены, „бактэрыяльныя“ праймеры</caption>
  <tbody class="primer-cov-tbody">
  <tr>
    <th class="alnleft" rowspan="2">Тып</th>
    <th class="numcol" rowspan="2">Колькасць<br />геномаў</th>
...
<p><sup>**</sup> Зыходная назва праймера Ar1378R — 1378R. Мы змянілі назву, каб пазбегнуць блытаніны.</p>
</details>
...
<h2>Кантакты</h2>
<p>Калі вы маеце пытанне пра RiboGrove, калі ласка, звяртайцеся да Максіма Сікаленкі на эл. адрас &#115;&#105;&#107;&#111;&#108;&#101;&#110;&#107;&#111;&#64;&#109;&#98;&#105;&#111;&#46;&#98;&#97;&#115;&#45;&#110;&#101;&#116;&#46;&#98;&#121; або &#109;&#97;&#120;&#105;&#109;&#100;&#101;&#121;&#110;&#111;&#110;&#105;&#104;&#64;&#103;&#109;&#97;&#105;&#108;&#46;&#99;&#111;&#109;.</p>
<hr>
...
<p>Апроч таго, можна цытаваць базу дадзеных RiboGrove саму па сабе на Zenod:</p>
<ul>
  <li>RiboGrove безадносна канкрэтнага выпуску: <a href="https://doi.org/{{ zenodo_ribogrove_doi }}">DOI: {{ zenodo_ribogrove_doi }}</a>;</li>
  <li>Канкрэтна выпуск {{ zenodo_record_id }}: <a href="https://doi.org/{{ zenodo_doi }}">DOI: {{ zenodo_doi }}</a>.</li>
</ul>
<hr>
