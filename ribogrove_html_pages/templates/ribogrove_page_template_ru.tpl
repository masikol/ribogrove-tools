...
<li><a href="#top-density-highest">Топ-10 геномов с наибольшей плотностью генов 16S рРНК</a></li>
<li><a href="#top-density-lowest">Топ-10 геномов с наименьшей плотностью генов 16S рРНК</a></li>
...
<ol style="list-style:none;">
  <li><strong>Категория 1</strong> (наибольшая достоверность). Геномы, которые не демонстрируют признаков низкокачественной сборки и которые были секвенированы с помощью технологии PacBio либо комбинации (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina) или (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina).</li>
...
<ul>
<li>Fasta-файл полноразмерных последовательностей генов 16S рРНК. <a href="https://zenodo.org/records/{{ zenodo_record_id }}/files/ribogrove_{{ ribogrove_release_number }}_sequences.fasta.gz?download=1">Скачать (gzipʼнутый fasta-файл, {{ final_fasta_fsize_fmt }} Мб)</a></li>
<li>Метаданные. <a href="https://zenodo.org/records/{{ zenodo_record_id }}/files/metadata_ribogrove_{{ ribogrove_release_number }}.zip?download=1">Скачать (zip-архив {{ metadata_fsize_fmt }} Мб)</a><br>
<details>
  ...
  <small>
    ...
    <li>
      <span class="samp-highl">primer_pair_genomic_coverage.tsv</span><br>
      Это TSV-файл, который содержит значения плотности генов 16S рРНК для каждого генома. Плотность определяется как количество копий гена 16S рРНК, делённое на размер генома и умноженное на 1 миллион пар оснований; таким образом, это количество генов 16S рРНК на 1 млн. п.н.
    </li>
  </ol></small>
</details>
</li>
...
<table class="sum-table"><caption>Топ-10 геномов с наибольшей плотностью генов 16S рРНК
</caption>
<tbody>
<tr><th class="alnleft">Организм</th><th class="numcol">Плотность генов<br />16S рРНК<sup> *</sup></th><th class="numcol">Число копий<br />генов 16S рРНК</th><th class="numcol">Размер генома<sup> **</sup></th><th class="alnleft">Код доступа<br>геномной сборки</th></tr>
<tr>
...
<p><sup>*</sup> Плотность генов 16S рРНК — это число копий гена 16S рРНК, делённое на размер генома и умноженное на 1 миллион пар оснований, таким образом, это количество генов 16S рРНК на 1 млн. п.н.</p>
<p><sup>**</sup> Размер генома — это сумма длин всех последовательностей сборки.</p>

<div id="top-density-lowest" class="pad-anchor"></div>
<table class="sum-table"><caption>Топ-10 геномов с наименьшей плотностью генов 16S рРНК
</caption>
<tbody>
<tr><th class="alnleft">Организм</th><th class="numcol">Плотность генов<br />16S рРНК<sup> *</sup></th><th class="numcol">Число копий<br />генов 16S рРНК</th><th class="numcol">Размер генома<sup> **</sup></th><th class="alnleft">Код доступа<br>геномной сборки</th></tr>
<tr>
...
<p>Есть более подробная таблица — в файле <span class="samp">primer_pair_genomic_coverage.tsv</span> в метаданных <a href="#downloads">metadata</a>. Та таблица содержит спектры действия не только для отделов (phyla), но и для каждого царства (kingdom), класса, порядка, семейства, рода и вида. Кроме того, та таблица содержит спектры действия для дополнительных пар праймеров, а именно: {{ unwanted_primer_pairs }}. В таблицах ниже нет этих пар, чтобы таблицы не были слишком громоздкими.</p>
...
<li>Строка таксономии, а именно названия домена (<span class="samp-highl">Bacteria</span>), царства (<span class="samp-highl">Bacillati</span>), отдела (<span class="samp-highl">Bacillota</span>), класса (<span class="samp-highl">Bacilli</span>), порядка (<span class="samp-highl">Bacillales</span>), семейства (<span class="samp-highl">Bacillaceae</span>) и рода (<span class="samp-highl">Bacillus</span>), а также видовой эпитет (<span class="samp-highl">cereus</span>).<br>
Перед каждым названием пишется префикс, который обозначает ранг: <span class="samp-highl">d__</span> для домена, <span class="samp-highl">k__</span> для царства, <span class="samp-highl">p__</span> для отдела, <span class="samp-highl">c__</span> для класса, <span class="samp-highl">o__</span> для порядка, <span class="samp-highl">f__</span> для семейства, <span class="samp-highl">g__</span> для рода и <span class="samp-highl">s__</span> для видового эпитета. В префиксах после буквы пишутся <strong>два</strong> знака нижнего подчёркивания.<br>
...
<p class="samp-comment">Обратите внимание на опцию <span class="samp">-v</span> внутри строки с опциями (<span class="samp">-nvrp</span>). Эта опция инвертирует поведение программы, и теперь она находит только те последовательности, в заголовках которых нет подстроки «<span class="samp">;p__Bacillota;</span>».</p>
...
<h2>Контакты</h2>
<p>Если у вас есть вопрос про RiboGrove, пожалуйста, обращайтесь к Максиму Сиколенко на эл. адрес &#115;&#105;&#107;&#111;&#108;&#101;&#110;&#107;&#111;&#64;&#109;&#98;&#105;&#111;&#46;&#98;&#97;&#115;&#45;&#110;&#101;&#116;&#46;&#98;&#121; или &#109;&#97;&#120;&#105;&#109;&#100;&#101;&#121;&#110;&#111;&#110;&#105;&#104;&#64;&#103;&#109;&#97;&#105;&#108;&#46;&#99;&#111;&#109;.</p>
<hr>
...
<p>Кроме того, можно цитировать базу данных RiboGrove саму по себе на Zenodo:</p>
<ul>
  <li>RiboGrove безотносительно конкретного выпуска: <a href="https://doi.org/{{ zenodo_ribogrove_doi }}">DOI: {{ zenodo_ribogrove_doi }}</a>;</li>
  <li>Конкретно выпуск {{ zenodo_record_id }}: <a href="https://doi.org/{{ zenodo_doi }}">DOI: {{ zenodo_doi }}</a>.</li>
</ul>
<hr>
