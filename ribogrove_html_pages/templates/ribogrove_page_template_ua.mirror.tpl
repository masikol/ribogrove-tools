...
<ol style="list-style:none;">
  <li><strong>Категорія 1</strong> (найбільша надійність). Геноми, які не демонструють прикмет низкоякісної збірки і які були секвенувані за допомогою технології PacBio або комбінації (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina) або (Oxford&nbsp;Nanopore&nbsp;+&nbsp;Illumina).</li>
...
<details>
  ...
  <small>
    ...
    <li>
      ...
      Це TSV-файл, який утримує інформацію про внутрішньогеномну мінливість генів 16S рРНК. Внутрішньогеномну мінливість розраховували тільки для геномів категорії&nbsp;1, у яких є принаймні два гени 16S рРНК. Для оцінки мінливості выкористовували ентропію Шенона: вирівнювали послідовності генів кожного геному за допомогою програми <a href="https://mafft.cbrc.jp/alignment/software/">MAFFT</a>, і після розраховували ентропію для кожної колонки множинного вирівнювання.
    </li>
    <li>
...
<tr>
  <th class="alnleft" rowspan="2">Тип</th>
...
<table class="sum-table"><caption>Архейні гени, „архейні“ праймери</caption>
<tbody class="primer-cov-tbody">
<tr>
  <th class="alnleft" rowspan="2">Тип</th>
  <th class="numcol" rowspan="2">Кількість<br />геномів</th>
...
<details>
<summary><b>Бактеріальні гени, „архейні“ праймери</b></summary>
<div id="primers-coverages" class="pad-anchor"></div>
<table class="sum-table"><caption>Бактеріальні гени, „архейні“ праймери</caption>
<tbody class="primer-cov-tbody">
<tr>
  <th class="alnleft" rowspan="2">Тип</th>
  <th class="numcol" rowspan="2">Кількість<br />геномів</th>
...
<details>
<summary><b>Архейні гени, „бактеріальні“ праймери</b></summary>
<table class="sum-table"><caption>Архейні гени, „бактеріальні“ праймери</caption>
  <tbody class="primer-cov-tbody">
  <tr>
    <th class="alnleft" rowspan="2">Тип</th>
    <th class="numcol" rowspan="2">Кількість<br />геномів</th>
...
<details>
<summary><b>Праймери, спектр дії яких оцінювався</b></summary>
<table class="sum-table"><caption>Праймери, спектр дії яких оцінювався</caption>
<tbody>
...
<p><sup>**</sup> Початкова назва праймера Ar1378R — 1378R. Ми змінили назву, щоб запобігти плутанині.</p>
</details>
