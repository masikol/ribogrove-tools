...
<ul class="ribogrove-nested-list">
  <li><a href="#current-release">Актуальний реліз RiboGrove &mdash; {{ ribogrove_release_number }}</li>
...
<tbody>
<tr><th class="numcol">Кількість копій <sup>*</sup></th><th class="numcol" colspan="2">Бактерії</th><th class="numcol" colspan="2">Археї</th></tr>
...
<tbody>
<tr><th class="alnleft">Організм</th><th class="numcol">Сума ентропії<sup> *</sup>, біти</th><th class="numcol">Середня ентропія<sup> *</sup>, біти</th><th class="numcol">Кількість мінливих позіцій</th><th class="numcol">Кількість копій генів</th><th class="alnleft">Ідентифікатор<br> геномної збірки</th></tr>
<tr>
...
<p><sup>*</sup> Спектр диї пары праймерів &mdash; це видсоток геномів, які мають принаймні один ген 16S рРНК, який можливо заампліфікувати за допомогою ПЦР і з застосуванням цієї пари праймерів. Деталі описані у нашому <a href="#citing-ribogrove">артикулі про RiboGrove</a>.</p>
...
<p><sup>*</sup> Праймери 341F та 785R застосовуються у <a href="https://support.illumina.com/downloads/16s_metagenomic_sequencing_library_preparation.html">протоколі</a> підготовки бібліотеки для секвенування ампліконів регіонів V3&ndash;V4 генів 16S рРНК на апараті Illumina MiSeq.</p>
...
<ol>
<li>Ідентифікатор збірки геному, від якого походить послідовність гену: <span class="samp-highl">G_324861</span>. Перед ідентифікатором збірки пишеться префікс <span class="samp-highl">G_</span>, щоб забезпечити специфичність пошуку.</li>
...
<p class="samp-comment">Зверніть увагу на опцію <span class="samp">-v</span> у рядку з опціями <span class="samp">-nvrp</span>. Оця опція інвертує поведінку програми, і тепер вона знайде всі послідовності, заголовки яких <em>не</em> утримують рядку &laquo;<span class="samp">;p__Firmicutes;</span>&raquo;.</p>
