...
<p><strong>Example 3</strong>. Select all &ldquo;Assession.Version&rdquo;s.</p>
...
<p><strong>Example 4</strong>. Select all Assembly IDs.</p>
...
<p class="samp-comment">This might be done only if you have <span class="samp">cut</span>, <span class="samp">sed</span>, <span class="samp">sort</span> and <span class="samp">uniq</span> utilities installed (Linux and Mac OS systems should have them built-in).</p>
